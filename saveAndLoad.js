...
function loadGame() {
    ...
    if (game.flyweightActive && game.activeTrainers <= game.maxTrainers) {
        ...
        if (offlineTime >= 1_000) {
            flyweightInterval(flyweightFighters.intervalIndex);
            offlineGains(flyweightFighters.intervalIndex);
        }
    }
    if (game.bantamweightActive && game.activeTrainers <= game.maxTrainers) {
        ...
        if (offlineTime >= 1_000) {
            bantamweightInterval(bantamweightFighters.intervalIndex);
            offlineGains(bantamweightFighters.intervalIndex);
        }
    }
    if (game.featherweightActive && game.activeTrainers <= game.maxTrainers) {
        ...
        if (offlineTime >= 1_000) {
            featherweightInterval(featherweightFighters.intervalIndex);
            offlineGains(featherweightFighters.intervalIndex);
        }
    }
    if (game.lightweightActive && game.activeTrainers <= game.maxTrainers) {
        ...
        if (offlineTime >= 1_000) {
            lightweightInterval(lightweightFighters.intervalIndex);
            offlineGains(lightweightFighters.intervalIndex);
        }
    }
    if (game.welterweightActive && game.activeTrainers <= game.maxTrainers) {
        ...
        if (offlineTime >= 1_000) {
            welterweightInterval(welterweightFighters.intervalIndex);
            offlineGains(welterweightFighters.intervalIndex);
        }
    }
    updateUi();
